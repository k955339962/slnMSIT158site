...
using prjMSIT158API.Models;
using prjMSIT158API.Models.DTO;

namespace prjMSIT158API.Controllers
{
    ...
    public class SpotsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<CSpotsPagingDTO>> GetSpots([FromBody] CSearchDTO searchDTO)
        {
            //根據分類編號搜尋景點資料
